...
<div align="center">
  ...
  <h3 align="center">Marlin 2.1.2.5 Firmware + TFT firmware for Artillery Genius and Genius with BLT/Genius Pro /X1 3D printer </h3>
...
Why should you update your artillery firmware?
  ...
  - More release notes https://github.com/MarlinFirmware/Marlin/tree/2.1.2.5
...
<li><a href="https://github.com/dgtaheno/artillery-Genius-Marlinfw/blob/Marlin-2.1.2.1/Marlin%202.1.2.1.hex">Marlin 2.1.2.5.hex</a></li>


If you have Artillery Genius with BLTouch(not tested, your feedback is appreciated here):
<li><a href="https://github.com/dgtaheno/artillery-Genius-Marlinfw/blob/Marlin-2.1.2.1/Marlin%202.1.2.1_BLT.hex">Marlin 2.1.2.5_BLT.hex(work in progress)</a></li>

If you have Artillery Genius Pro(not tested, your feedback is appreciated here):

<li><a href="https://github.com/dgtaheno/artillery-Genius-Genius-Pro-X1-Marlinfw/blob/Marlin-2.1.2.1/Marlin%202.1.2.1_PRO.bin">Marlin 2.1.2.5_PRO.bin(work in progress)</a></li>

If you have Artillery X1(not tested, your feedback is appreciated here):
<li><a href="https://github.com/dgtaheno/artillery-Genius-Marlinfw/blob/Marlin-2.1.2.1/Marlin%202.1.2.1-X1.hex">Marlin 2.1.2.5-X1.hex(work in progress)</a></li>

And these files are general and common for all these versions(Artillery Genius(with and without BLT)/X1):
...
First, you need to flash the board firmware. I am using Prusa Slicer to flash.
  ...
  1. Download the [Marlin 2.1.2.5.hex](https://github.com/dgtaheno/artillery-Genius-Marlinfw/blob/Marlin-2.1.2.5/Marlin%202.1.2.5.hex) for Artillery Genius firmware or [Marlin 2.1.2.5_BLT.hex](https://github.com/dgtaheno/artillery-Genius-Marlinfw/blob/Marlin-2.1.2.5/Marlin%202.1.2.5_BLT.hex) if you have Genius with BLTouch installed or [Marlin 2.1.2.5_PRO.bin](https://github.com/dgtaheno/artillery-Genius-Genius-Pro-X1-Marlinfw/blob/Marlin-2.1.2.5/Marlin%202.1.2.5_PRO.bin) if you have Genius PRO or [Marlin 2.1.2.5-X1.hex](https://github.com/dgtaheno/artillery-Genius-Marlinfw/blob/Marlin-2.1.2.5/Marlin%202.1.2.5-X1.hex) if you have X1.
  2. Open Prusa Slicer
  3. Go to Configuration -> Flash printer firmware
  4. Select the Marlin 2.1.2.5.hex or 2.1.2.5_BLT.hex(if you have BLTouch installed) or 2.1.2.5_PRO.bin(if you have Genius PRO) or 2.1.2.5-X1.hex(if you have the X1) file provided, and choose the correct serial port for your printer.
...
Second you need to update TFT firmware(Skip this step if already updated(only Genius and X1)):
